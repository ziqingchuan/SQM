...
产品需求：描述开发团队针对客户需求提供的解决方案。`},{question:"",answer:""},{question:"",answer:""},{question:"",answer:""},{question:"",answer:""},{question:"",answer:""},{question:"",answer:""}],rl={class:"container"},il={class:"header"},ol={class:"tab-container"},ll={key:0},cl={key:0,class:"question-container"},fl={class:"question-header"},ul={class:"question-number"},al={key:0,class:"question-type"},dl={key:1,class:"question-type"},hl={class:"question-content"},pl={class:"options-container"},gl=["onClick"],_l={class:"option-letter"},ml={class:"option-text"},bl={class:"controls"},vl=["disabled"],yl={key:1,class:"result-container"},Cl={class:"score-circle"},wl={class:"score-text"},xl={key:0,class:"incorrect-questions"},Al={key:1,class:"short-answer-container"},Sl={class:"short-answer-question"},Dl={class:"short-answer-answer"},Tl={class:"controls"},Pl=["disabled"],El=["disabled"],Ol=ir({__name:"Exercise",setup(e){const t=ze(!1),n=ze(0),s=ot(()=>yn[n.value]),r=()=>{n.value>0&&n.value--},i=()=>{n.value<yn.length-1&&n.value++},o=ze([{question:"",userAnswer:"",correctAnswer:""}]),l=F=>{const P=F.split(`
`),$=[],fe=/^([A-Z]) : (.+)$/;for(let re=0;re<P.length;re++){const Me=P[re].match(fe);Me&&$.push({letter:Me[1],text:Me[2]})}return $},u=ot(()=>be.map(F=>({...F,options:l(F.question),isMultiple:F.question.includes("多选")}))),d=ze(0),a=ze(Array(be.length).fill("")),p=ze(!1),x=ze(0);ot(()=>(d.value+1)/be.length*100);const A=ot(()=>u.value[d.value]),R=F=>a.value[d.value].includes(F),M=F=>{const P=a.value[d.value];A.value.isMultiple?P.includes(F)?a.value[d.value]=P.replace(F,""):a.value[d.value]=P+F:a.value[d.value]=F},X=()=>{d.value>0&&d.value--},N=()=>{d.value<be.length-1&&d.value++},Q=()=>{let F=0;const P=[];for(let $=0;$<be.length;$++){const fe=[...a.value[$]].sort().join(""),re=[...be[$].answer].sort().join("");fe===re?F++:P.push({question:be[$].question,userAnswer:fe||"未作答",correctAnswer:re})}x.value=F,o.value=P,p.value=!0},Y=()=>{const F=x.value/be.length*100;return F>=90?"太棒了！您已经掌握了这些知识点！":F>=70?"做得很好！继续努力！":F>=50?"不错的尝试！复习一下会更好！":"需要更多练习，加油！"},T=ot(()=>{const F=x.value/be.length*100;return F>=90?"excellent":F>=70?"good":F>=50?"average":"poor"}),G=()=>{d.value=0,a.value=Array(be.length).fill(""),p.value=!1,x.value=0};return(F,P)=>(ee(),ae("div",rl,[I("div",il,[P[2]||(P[2]=I("h1",null,"软件质量管理",-1)),I("div",ol,[I("button",{class:tt(["tab-btn",{active:!t.value}]),onClick:P[0]||(P[0]=$=>t.value=!1)}," 选择题 ",2),I("button",{class:tt(["tab-btn",{active:t.value}]),onClick:P[1]||(P[1]=$=>t.value=!0)}," 简答题 ",2)])]),t.value?(ee(),ae("div",Al,[I("div",Sl,de(s.value.question),1),I("div",Dl,[I("p",null,de(s.value.answer),1)]),I("div",Tl,[I("button",{class:"btn btn-prev",onClick:r,disabled:n.value===0},P[11]||(P[11]=[I("i",{class:"fas fa-arrow-left"},null,-1),Te(" 上一题 ")]),8,Pl),I("button",{class:"btn btn-next",onClick:i,disabled:n.value===Nt(yn).length-1},P[12]||(P[12]=[Te(" 下一题 "),I("i",{class:"fas fa-arrow-right"},null,-1)]),8,El)])])):(ee(),ae("div",ll,[p.value?(ee(),ae("div",yl,[P[10]||(P[10]=I("h2",{class:"result-title"},"测试完成!",-1)),I("div",Cl,[I("div",wl,de(x.value)+" / "+de(Nt(be).length),1)]),I("div",{class:tt(["feedback",T.value])},de(Y()),3),o.value.length?(ee(),ae("div",xl,[P[8]||(P[8]=I("h3",null,"您答错的题目：",-1)),(ee(!0),ae(ye,null,is(o.value,($,fe)=>(ee(),ae("div",{key:fe,class:"incorrect-question"},[I("p",null,[I("strong",null,"题目 "+de(fe+1)+"：",1),Te(" "+de($.question.split(`

`)[0]),1)]),I("p",null,[P[6]||(P[6]=I("strong",null,"您的答案：",-1)),Te(" "+de($.userAnswer),1)]),I("p",null,[P[7]||(P[7]=I("strong",null,"正确答案：",-1)),Te(" "+de($.correctAnswer),1)])]))),128))])):wo("",!0),I("button",{class:"restart-btn",onClick:G},P[9]||(P[9]=[I("i",{class:"fas fa-redo"},null,-1),Te(" 重新测试 ")]))])):(ee(),ae("div",cl,[I("div",fl,[I("div",ul,"题目 "+de(d.value+1),1),A.value.isMultiple?(ee(),ae("div",al,"多选题")):(ee(),ae("div",dl,"单选题"))]),I("div",hl,de(A.value.question.split(`

`)[0]),1),I("div",pl,[(ee(!0),ae(ye,null,is(A.value.options,($,fe)=>(ee(),ae("div",{key:fe,class:tt(["option",{selected:R($.letter)}]),onClick:re=>M($.letter)},[I("div",_l,de($.letter),1),I("div",ml,de($.text),1)],10,gl))),128))]),I("div",bl,[I("button",{class:"btn btn-prev",onClick:X,disabled:d.value===0},P[3]||(P[3]=[I("i",{class:"fas fa-arrow-left"},null,-1),Te(" 上一题 ")]),8,vl),d.value<Nt(be).length-1?(ee(),ae("button",{key:0,class:"btn btn-next",onClick:N},P[4]||(P[4]=[Te(" 下一题 "),I("i",{class:"fas fa-arrow-right"},null,-1)]))):(ee(),ae("button",{key:1,class:"btn btn-finish",onClick:Q},P[5]||(P[5]=[Te(" 完成测试 "),I("i",{class:"fas fa-check"},null,-1)])))])]))]))]))}}),Bl=(e,t)=>{const n=e.__vccOpts||e;for(const[s,r]of t)n[s]=r;return n},Il=Bl(Ol,[["__scopeId","data-v-e6ce5fd2"]]),Ml=ir({__name:"App",setup(e){return(t,n)=>(ee(),Pr(Il,{msg:"Vite + Vue"}))}});tl(Ml).mount("#app");
