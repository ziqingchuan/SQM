...
7. 开发人员：负责软件产品的开发`}],rl={class:"container"},il={class:"header"},ol={class:"tab-container"},ll={key:0},cl={key:0,class:"question-container"},fl={class:"question-header"},ul={key:0,class:"question-type"},al={key:1,class:"question-type"},dl={class:"question-content"},hl={class:"options-container"},pl=["onClick"],gl={class:"option-letter"},_l={class:"option-text"},ml={class:"controls"},bl=["disabled"],vl={key:1,class:"result-container"},yl={class:"score-circle"},Cl={class:"score-text"},wl={key:0,class:"incorrect-questions"},xl={key:1,class:"short-answer-container"},Al={class:"short-answer-question"},Sl={class:"short-answer-answer"},Dl={class:"controls"},Tl=["disabled"],Pl=["disabled"],El=ir({__name:"Exercise",setup(e){const t=ze(!1),n=ze(0),s=ot(()=>yn[n.value]),r=()=>{n.value>0&&n.value--},i=()=>{n.value<yn.length-1&&n.value++},o=ze([{question:"",userAnswer:"",correctAnswer:""}]),l=F=>{const T=F.split(`
`),j=[],fe=/^([A-Z]) : (.+)$/;for(let re=0;re<T.length;re++){const Me=T[re].match(fe);Me&&j.push({letter:Me[1],text:Me[2]})}return j},u=ot(()=>be.map(F=>({...F,options:l(F.question),isMultiple:F.question.includes("多选")}))),d=ze(0),a=ze(Array(be.length).fill("")),p=ze(!1),x=ze(0);ot(()=>(d.value+1)/be.length*100);const A=ot(()=>u.value[d.value]),R=F=>a.value[d.value].includes(F),M=F=>{const T=a.value[d.value];A.value.isMultiple?T.includes(F)?a.value[d.value]=T.replace(F,""):a.value[d.value]=T+F:a.value[d.value]=F},X=()=>{d.value>0&&d.value--},N=()=>{d.value<be.length-1&&d.value++},Q=()=>{let F=0;const T=[];for(let j=0;j<be.length;j++){const fe=[...a.value[j]].sort().join(""),re=[...be[j].answer].sort().join("");fe===re?F++:T.push({question:be[j].question,userAnswer:fe||"未作答",correctAnswer:re})}x.value=F,o.value=T,p.value=!0},Y=()=>{const F=x.value/be.length*100;return F>=90?"太棒了！您已经掌握了这些知识点！":F>=70?"做得很好！继续努力！":F>=50?"不错的尝试！复习一下会更好！":"需要更多练习，加油！"},P=ot(()=>{const F=x.value/be.length*100;return F>=90?"excellent":F>=70?"good":F>=50?"average":"poor"}),G=()=>{d.value=0,a.value=Array(be.length).fill(""),p.value=!1,x.value=0};return(F,T)=>(ee(),ae("div",rl,[I("div",il,[T[2]||(T[2]=I("h1",null,"软件质量管理",-1)),I("div",ol,[I("button",{class:tt(["tab-btn",{active:!t.value}]),onClick:T[0]||(T[0]=j=>t.value=!1)}," 选择题 ",2),I("button",{class:tt(["tab-btn",{active:t.value}]),onClick:T[1]||(T[1]=j=>t.value=!0)}," 简答题 ",2)])]),t.value?(ee(),ae("div",xl,[I("div",Al,ge(s.value.question),1),I("div",Sl,[I("p",null,ge(s.value.answer),1)]),I("div",Dl,[I("button",{class:"btn btn-prev",onClick:r,disabled:n.value===0},T[12]||(T[12]=[I("i",{class:"fas fa-arrow-left"},null,-1),Te(" 上一题 ")]),8,Tl),I("button",{class:"btn btn-next",onClick:i,disabled:n.value===Nt(yn).length-1},T[13]||(T[13]=[Te(" 下一题 "),I("i",{class:"fas fa-arrow-right"},null,-1)]),8,Pl)])])):(ee(),ae("div",ll,[p.value?(ee(),ae("div",vl,[T[11]||(T[11]=I("h2",{class:"result-title"},"测试完成!",-1)),I("div",yl,[I("div",Cl,ge(x.value)+" / "+ge(Nt(be).length),1)]),I("div",{class:tt(["feedback",P.value])},ge(Y()),3),o.value.length?(ee(),ae("div",wl,[T[9]||(T[9]=I("h3",null,"您答错的题目：",-1)),(ee(!0),ae(ye,null,is(o.value,(j,fe)=>(ee(),ae("div",{key:fe,class:"incorrect-question"},[I("p",null,[I("strong",null,"题目 "+ge(fe+1)+"：",1),Te(" "+ge(j.question.split(`

`)[0]),1)]),I("p",null,[T[7]||(T[7]=I("strong",null,"您的答案：",-1)),Te(" "+ge(j.userAnswer),1)]),I("p",null,[T[8]||(T[8]=I("strong",null,"正确答案：",-1)),Te(" "+ge(j.correctAnswer),1)])]))),128))])):wo("",!0),I("button",{class:"restart-btn",onClick:G},T[10]||(T[10]=[I("i",{class:"fas fa-redo"},null,-1),Te(" 重新测试 ")]))])):(ee(),ae("div",cl,[I("div",fl,[T[3]||(T[3]=I("div",{class:"link-container"},[I("a",{href:"https://ziqingchuan.github.io/SSD/",target:"_blank",class:"link-btn"}," 软件系统设计复习网站 ")],-1)),A.value.isMultiple?(ee(),ae("div",ul,"多选题")):(ee(),ae("div",al,"单选题"))]),I("div",dl,ge(A.value.question.split(`

`)[0]),1),I("div",hl,[(ee(!0),ae(ye,null,is(A.value.options,(j,fe)=>(ee(),ae("div",{key:fe,class:tt(["option",{selected:R(j.letter)}]),onClick:re=>M(j.letter)},[I("div",gl,ge(j.letter),1),I("div",_l,ge(j.text),1)],10,pl))),128))]),I("div",ml,[I("button",{class:"btn btn-prev",onClick:X,disabled:d.value===0},T[4]||(T[4]=[I("i",{class:"fas fa-arrow-left"},null,-1),Te(" 上一题 ")]),8,bl),d.value<Nt(be).length-1?(ee(),ae("button",{key:0,class:"btn btn-next",onClick:N},T[5]||(T[5]=[Te(" 下一题 "),I("i",{class:"fas fa-arrow-right"},null,-1)]))):(ee(),ae("button",{key:1,class:"btn btn-finish",onClick:Q},T[6]||(T[6]=[Te(" 完成测试 "),I("i",{class:"fas fa-check"},null,-1)])))])]))]))]))}}),Ol=(e,t)=>{const n=e.__vccOpts||e;for(const[s,r]of t)n[s]=r;return n},Bl=Ol(El,[["__scopeId","data-v-e4a10ec3"]]),Il=ir({__name:"App",setup(e){return(t,n)=>(ee(),Pr(Bl,{msg:"Vite + Vue"}))}});tl(Il).mount("#app");
