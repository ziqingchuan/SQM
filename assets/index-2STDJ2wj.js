...
2. 可以工作的软件胜过详尽的文档
3. 客户合作胜过合同谈判
4. 响应变化胜过遵循计划`},{question:"敏捷方法的特征有哪些？哪些关于敏捷方法的特征表述可能带有误导？为什么？",answer:`特征：
① 小周期迭代式；② 持续交付；③ 敏捷宣言
带有误导的表述：
...
2. 重视小组评审与个人评审
3. 重视设计
4. 开展设计验证`},{question:"如何制定一份让人无法拒绝的计划？请描述剧本步骤和一些注意事项。",answer:`1. 制定任务计划，描述项目所有的任务清单，人物之间的先后顺序以及每个任务所需时间资源。
